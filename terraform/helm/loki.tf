resource "helm_release" "loki" {
    ...
    values = [
      templatefile(var.loki_chart_template,
        {
          ...
          minio_service_monitor_label                  = var.minio_service_monitor_label
          loki_service_monitor_label                   = var.loki_service_monitor_label
